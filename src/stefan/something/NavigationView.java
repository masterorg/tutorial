...
public class NavigationView extends ViewPart {
	public static final String ID = "stefan.something.navigationView";
    ...
    private TreeObject createDummyModel() {
        ...
        //another treeObject
        TreeParent p3 = new TreeParent("Sent mail");
        TreeObject o = new TreeObject("Milena");
        p3.addChild(o);
        o = new TreeObject("Sara");
        p3.addChild(o);
